...
public class GameLoop : MonoBehaviour, IGameLoop
{
    ...
    private void LoadScene(int escenaBuildIndex)
    {
        ...
        {
            ServiceLocator.Instance.GetService<ITransitionServiceBoostrap>().OcultarCortinilla();
            ServiceLocator.Instance.GetService<ITransitionServiceBoostrap>().OnEscenaLista -= LoadScene;
        }
    }
    ...
    {
        ServiceLocator.Instance.GetService<ITransitionServiceBoostrap>().OnEscenaLista += LoadScene;
        ServiceLocator.Instance.GetService<ITransitionServiceBoostrap>().OnCargaFinalizada += StartControlled;
        ServiceLocator.Instance.GetService<ITransitionServiceBoostrap>().OcultarCortinilla();
    }
    ...
    private void ConfigureGameLoop()
    {
        ...
        _end = this.tt().Pause().Add(() =>
            ...
            {
                ServiceLocator.Instance.GetService<ITransitionServiceBoostrap>().IniciarCarga(nextScene + 1, 1);
            });
    }
